...
del usuario tres veces, una con todas las letras minúsculas, otra con todas las letras mayúsculas y otra solo 
...
name = input("Ingrese su nombre completo por favor: ")
